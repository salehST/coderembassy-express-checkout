...
class AjaxHandler
{
    ...
    public function add_to_cart()
    {
        ...
        foreach ($products_data as $product_data) {
            ...
            // Check if product is already in cart to set quantity instead of adding
            $cart_id = WC()->cart->generate_cart_id($product_id, $variation_id, $variation_attributes);
    ...
    private function find_matching_variation($product, $variation_attributes)
    {
        ...
        foreach ($variations as $variation_data) {
            ...
            foreach ($variation_attributes as $attribute_name => $attribute_value) {
                ...
                if (
                    !isset($variation_attributes_data[$attribute_slug]) ||
